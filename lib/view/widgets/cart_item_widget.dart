              ...
              children: [
                ...
                Text.rich(
                  TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: cartItem.productSize.name,
                        style: Theme.of(context).textTheme.titleMedium,
                      ),
                    ],
                  ),
                ...
                BlocBuilder<CartCubit, CartState>(
                  bloc: cubit,
                  buildWhen: (previous, current) => current is ProductCartQuantityLoaded && current.productId == cartItem.product.id,
                  builder: (context, state) {
                    if (state is ProductCartQuantityLoaded) {
                      return Row(
                        ...
                        children: [
                          ...
                          Text(
                            '\$${(state.counterValue * cartItem.product.price).toStringAsFixed(1)}',
